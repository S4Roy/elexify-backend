...
const AuditLogSchema = new Schema(
  {
    ...
    event: {
      ...
      enum: [
        ...
        "SYSTEM_SEEDER_EXECUTED",
        "SYSTEM_MIGRATION_EXECUTED",
        "SYSTEM_BACKFILL_EXECUTED",
        "SYSTEM_REPAIR_EXECUTED",
        "INTEGRATION_CREDENTIAL_UPDATED",
        "INTEGRATION_CREDENTIAL_CLEARED",
        "INTEGRATION_CREDENTIAL_TESTED",
        "ZOHO_INVOICE_SYNCED",
        "ZOHO_INVOICE_SYNC_FAILED",
        "FULFILLMENT_POLICY_UPDATED",
        "RETURN_REQUESTED",
        "RETURN_REVIEWED",
        "RETURN_RECEIVED",
        "RETURN_INSPECTED",
