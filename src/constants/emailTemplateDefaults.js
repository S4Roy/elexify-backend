// Default (subject, body) copy per EmailTemplate `action`, used to seed a
// fresh environment (scripts/seedEmailTemplates.js) and to audit template
// rendering in tests. Pure data — no side effects — so it can be imported
// without opening a Mongo connection.
...
// the existing EmailTemplate admin UI at any time; re-running the seed
// script afterward will not overwrite their changes.
